...
describe("парсинг даты", () => {
  it("01: дата с таймзоной в ISO формате возвращается корректно", (done) => {
    ...
    result.should.be
      .instanceof(String)
      .which.is.equal("2018-06-01T18:17:12.745+07:00");
    done();
  });
  ...
  it("02: дата UTC в ISO формате возвращается корректно", (done) => {
    ...
    result.should.be
      .instanceof(String)
      .which.is.equal("2018-06-01T18:17:12.745Z");
    done();
  });
  ...
  it("03: дата UTC без Z и без мсек возвращается корректно", (done) => {
    ...
    result.should.be
      .instanceof(String)
      .which.is.equal("2018-06-01T18:17:12.000Z");
    done();
  });
  ...
  it("05: дата с таймзоной без времени возвращается корректно", (done) => {
    ...
    result.should.be
      .instanceof(String)
      .which.is.equal("2018-06-01T00:00:00.000+07:00");
    done();
  });
  ...
  it("06: дата без таймзоны и времени возвращается корректно", (done) => {
    ...
    result.should.be
      .instanceof(String)
      .which.is.equal("2018-06-01T00:00:00.000Z");
    done();
  });
  ...
  it("07: дата парсится из строки вида [... DD-MM-YYYY ... HH:mm ...]", function (done) {
    ...
    result.should.be
      .instanceof(String)
      .which.is.equal("2018-03-12T11:00:00.000Z");
    done();
  });
  ...
  it("08: дата парсится из строки вида [... YYYY-MM-DD ... HH:mm ...]", function (done) {
    ...
    result.should.be
      .instanceof(String)
      .which.is.equal("2018-05-17T15:00:00.000Z");
    done();
  });
  ...
  it("11: дата парсится из строки вида [... DD-MM-YYYY ...]", function (done) {
    ...
    result.should.be
      .instanceof(String)
      .which.is.equal("2018-03-12T00:00:00.000Z");
    done();
  });
  ...
  it("12: дата парсится из строки вида [... YYYY-MM-DD ...]", function (done) {
    ...
    result.should.be
      .instanceof(String)
      .which.is.equal("2018-05-17T00:00:00.000Z");
    done();
  });
  ...
  it("15: дата парсится из строки вида [... D month YYYY ...]", function (done) {
    ...
    result.should.be
      .instanceof(String)
      .which.is.equal("2017-01-01T00:00:00.000Z");
    done();
  });
  ...
  it("16: дата парсится из строки вида [... DD month YYYY ...]", function (done) {
    ...
    result.should.be
      .instanceof(String)
      .which.is.equal("2018-08-11T00:00:00.000Z");
    done();
  });
  ...
  it("17: дата парсится из строки вида [... DD mon. YYYY ...]", function (done) {
    ...
    result.should.be
      .instanceof(String)
      .which.is.equal("2018-12-02T00:00:00.000Z");
    done();
  });
  ...
  it('18: дата парсится из строки вида [... "DD" mon. YYYY ...]', function (done) {
    ...
    result.should.be
      .instanceof(String)
      .which.is.equal("2018-11-02T00:00:00.000Z");
    done();
  });
  ...
  it("19: дата парсится из строки вида [... «DD» mon. YYYY ...]", function (done) {
    ...
    result.should.be
      .instanceof(String)
      .which.is.equal("2018-09-02T00:00:00.000Z");
    done();
  });
  ...
  it("20: дата парсится из строки вида [... DD/MM/YYYY ...]", function (done) {
    ...
    result.should.be
      .instanceof(String)
      .which.is.equal("2018-03-27T10:00:00.000Z");
    done();
  });
});
